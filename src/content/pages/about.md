---
title: "Sobre"
description: "Conheça a equipe editorial do Bundesliga Market, a origem dos dados e os critérios aplicados às análises de EA FC."
---

O **Bundesliga Market** é uma publicação editorial especializada em EA FC Ultimate Team. Nosso foco é claro: preços e mercado da Bundesliga no EA FC Ultimate Team, atualizados todos os dias com dados reais.

## Quem assina

As publicações são assinadas por **Bundesliga Market**. O sistema organiza dados de mercado, produz tabelas e aplica regras editoriais reproduzíveis antes de liberar cada análise. Dúvidas, correções e sugestões podem ser enviadas para [contato@futquant.com](mailto:contato@futquant.com).
