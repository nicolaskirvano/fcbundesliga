...
faq:
  - q: "Qual a melhor carta para investir hoje (31/05/2026) no EA FC?"
    a: "Danny da Costa (84, Bundesliga) lidera, com +47.5% em 7 dias a 22k coins no PC, e o modelo dá 32% de chance de seguir subindo."
...
- **Can Uzun (89)** — 90k coins, **+12.5% em 7 dias** (+18.4% em 24h). Preço em linha com a média de 7 dias (+4%). Momentum positivo; acompanhe para escolher o ponto de entrada.

- **Edmond Tapsoba (86)** — 22k coins, **+7.5% em 7 dias** (+10.3% em 24h). Preço em linha com a média de 7 dias (+3%). Momentum positivo; acompanhe para escolher o ponto de entrada.
...
Danny da Costa (84, Bundesliga) lidera, com +47.5% em 7 dias a 22k coins no PC, e o modelo dá 32% de chance de seguir subindo.
